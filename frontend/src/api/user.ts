...
export const userApi = {
  ...
  getAll: async (params?: { active?: boolean; role?: string; firstName?: string; lastName?: string; email?: string; q?: string; user_id?: string; start_at?: string; end_at?: string; limit?: number; offset?: number }): Promise<ApiResponse<User[]>> => {
